...
Due to 2FA and AGOL role limitations, for this project, the user must manually update the AGOL hosted table with the main CSV to update the dashboard. See ```docs/pipeline_configuration.md``` for instructions on how to fully automate the workflow if you do not have these limitations.
